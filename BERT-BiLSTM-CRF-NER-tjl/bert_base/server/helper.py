...
def get_args_parser():
    ...
    bert_path = r'D:\localE\code\daguang_extract\BERT-BiLSTM-CRF-NER-master\chinese_L-12_H-768_A-12\BERT'
    ...
    group1.add_argument('-bert_model_dir', type=str,default=bert_path,
                        help='chinese google bert model path')

    group1.add_argument('-model_dir', type=str, default=os.path.join(root_path, 'output'),
